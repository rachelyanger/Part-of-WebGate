  ...
  init(){
      ...
      if(n4==1){
        ...
        for(let i=0;i<n4;i++){
          ...
          geo4_i.position.set(this.a.scanner.level4[i].translation.value[0],this.a.scanner.level4[i].translation.value[1],this.a.scanner.level4[i].translation.value[2]);
      ...
      if(n5==1){
        ...
        for(let i=0;i<n5;i++){
          ...
          geo5_i.position.set(this.a.scanner.level5[i].translation.value[0],this.a.scanner.level5[i].translation.value[1],this.a.scanner.level5[i].translation.value[2]);
